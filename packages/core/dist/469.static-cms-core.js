"use strict";
(globalThis["webpackChunkStaticCmsCore"] = globalThis["webpackChunkStaticCmsCore"] || []).push([[469],{
...
;// CONCATENATED MODULE: ../../node_modules/@lezer/sass/dist/index.es.js
...
const cssHighlighting = (0,highlight_dist/* styleTags */.Gv)({
  ...
  ParenthesizedContent: highlight_dist/* tags.special */.pJ.special(highlight_dist/* tags.name */.pJ.name),
  ColorLiteral: highlight_dist/* tags.color */.pJ.color,
  StringLiteral: highlight_dist/* tags.string */.pJ.string,
...
var lang_css_dist = __webpack_require__(20566);
...
function sass(config) {
    return new language_dist/* LanguageSupport */.ri((config === null || config === void 0 ? void 0 : config.indented) ? indentedSassLanguage : sassLanguage, sassLanguage.data.of({ autocomplete: lang_css_dist.cssCompletionSource }));
}
...
//# sourceMappingURL=469.static-cms-core.js.map