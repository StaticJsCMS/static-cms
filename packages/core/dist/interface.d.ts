...
import type { ComponentType, FunctionComponent, JSXElementConstructor, ReactElement, ReactNode } from 'react';
...
export interface i18nCollection<EF extends BaseField = UnknownField> extends Omit<Collection<EF>, 'i18n'> {
...
export type Field<EF extends BaseField = UnknownField> = BooleanField | CodeField | ColorField | DateTimeField | FileOrImageField | KeyValueField | ListField<EF> | MapField | MarkdownField | NumberField | ObjectField<EF> | RelationField | SelectField | HiddenField | StringOrTextField | UUIDField | EF;
...
export type EventListener = PreSaveEventListener | PostSaveEventListener | ChangeEventListener | LoginEventListener | LogoutEventListener | MountedEventListener;
