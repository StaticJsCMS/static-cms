...
export const COLLECTION_CARD_HEIGHT = 240;
export const COLLECTION_CARD_IMAGE_HEIGHT = 196;
export const COLLECTION_CARD_HEIGHT_WITHOUT_IMAGE =
  COLLECTION_CARD_HEIGHT - COLLECTION_CARD_IMAGE_HEIGHT;
