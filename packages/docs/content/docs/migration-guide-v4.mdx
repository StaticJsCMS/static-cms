...
```bash
npm install @staticcms/core@^4.0.0-beta.5
```

Or if you are using yarn:

```bash
yarn add @staticcms/core@^4.0.0-beta.5
```

If you are using a CDN to load Static CMS, simply change your URLs:

```html
<link rel="stylesheet" href="https://unpkg.com/@staticcms/app@^4.0.0-beta.5/dist/main.css" />
```

```html
<script src="https://unpkg.com/@staticcms/app@^4.0.0-beta.5/dist/static-cms-app.js"></script>
```
