...
```bash
npm install @staticcms/core@^4.0.0-beta.0
```

Or if you are using yarn:

```bash
yarn add @staticcms/core@^4.0.0-beta.0
```

If you are using a CDN to load Static CMS, simply change your URLs:

```html
<link rel="stylesheet" href="https://unpkg.com/@staticcms/app@^4.0.0-beta.0/dist/main.css" />
```
